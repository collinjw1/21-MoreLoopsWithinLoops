...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 30
    answer = largest_number([(5, 10, 13, 20, 22),
                             (13, 30, 25, 25, 7),
                             [3, 2, 3, 4, 23, 26]])
    print('Expected and actual are:', expected, answer)
...
def largest_number(seq_seq):
    ...
    for k in range(len(seq_seq)):
        cantgetenough=seq_seq[k]
        for j in range(len(cantgetenough)):
            if cantgetenough[j] > index:
                index = cantgetenough[j]
...
def run_test_largest_negative_number():
    ...
    # Test 4:
    expected = -3
    answer = largest_negative_number([(5, -10, -13, -20, 22),
                             (-13, 30, -25, 25, 7),
                             [-3, 2, 3, -4, -23, 26]])
    print('Expected and actual are:', expected, answer)
...
def first_is_elsewhere_too(seq_seq):
    ...
    # ------------------------------------------------------------------
    fellintomylap=seq_seq[0]
    for k in range(len(seq_seq)-1):
        wasntevenlooking=seq_seq[k+1]
        for j in range(len(fellintomylap)):
            for l in range(len(wasntevenlooking)):
                if fellintomylap[j] == wasntevenlooking[l]:
                    return True
